<div class="row clearfix">
    <div class="col-xs-12">
        <div class="card">
            ...
            <div class="body">
                Bingung mau ngapain? unduh manual pengguna <a href="<?php echo base_url(); ?>asset/userguide/user_guide_dosen.pdf?" target="_blank">di sini</a>.
            </div>
        </div>
    </div>
    <div class="col-xs-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="align-right">
                    <a class="btn bg-cyan waves-effect" href="<?php echo base_url(); ?>Dosen/berita_lama/<?php echo date('Y') ?>">Berita Lama</a>
                </div>
            </div>
        </div>
    </div>
    <div class="col-xs-12">
        <div class="card">
            <div class="body">
                <img style="width: 100%; object-fit: contain" src="<?php echo base_url(); ?>asset/images/dashboard/dosenkelas.png" alt="Diagram"/> 
            </div>
        </div>
    </div>
</div>
