...
<div class="row clearfix">
    <div class="col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form autocomplete="off" role="form" action="<?php echo base_url(); ?>Dosen/verifikasipenilaian" method="post">
                    <div class="row clearfix">
                        <div class="col-md-3">
...
<div class="modal fade" id="tambah-file" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form autocomplete="off" role="form" action="<?php echo base_url(); ?>Dosen/tambah_fileverifikasipenilaian/<?php echo $tahun_selected.'/'.$semester_selected.'/'.$kelas_selected ?>" method="post" enctype="multipart/form-data">
...
<div class="row clearfix">
    ...
    <div class="modal fade" id="edit-file" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form autocomplete="off" role="form" action="<?php echo base_url(); ?>Dosen/tambah_fileverifikasipenilaian/<?php echo $f->tahun.'/'.$f->semester.'/'.$f->IDkelas ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-header">
    ...
    <div class="modal fade" id="hapus-penilaian-<?php echo $f->tahun ?>-<?php echo $f->semester ?>-<?php echo $f->IDkelas ?>" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-col-red">
                    <form autocomplete="off" class="form-horizontal" role="form" action="<?php echo base_url(); ?>Dosen/hapus_fileverifikasipenilaian/<?php echo $f->tahun.'/'.$f->semester.'/'.$f->IDkelas ?>" method="post">
                        <div class="modal-header">
