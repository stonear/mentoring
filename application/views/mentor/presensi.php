<div class="row clearfix">
    <div class="col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form autocomplete="off" role="form" action="<?php echo base_url(); ?>Mentor/presensi" method="post">
                    <div class="row clearfix">
                        <div class="col-md-3">
...
<?php if(!empty($peserta)): ?>
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="card">
                <div class="body">
                    <form autocomplete="off" role="form" action="<?php echo base_url(); ?>Mentor/update_presensi/<?php echo $tahun_selected.'/'.$semester_selected.'/'.$kelompok_selected ?>" method="post">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="body">
                    <a href="<?php echo base_url(); ?>Mentor/download_presensi/<?php echo $kelompok_selected ?>" class="btn btn-primary btn-block waves-effect"><i class="material-icons">file_download</i> UNDUH</a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="body">
                    <a href="<?php echo base_url(); ?>Mentor/download_templatepresensi/<?php echo $kelompok_selected ?>" class="btn btn-primary btn-block waves-effect"><i class="material-icons">file_download</i> UNDUH</a>
                </div>
            </div>
        </div>
        <div class="col-md-5">
                    ...
                    <div class="list-group">
                        <?php foreach ($file as $f): ?>
                            ...
                            <div class="list-group-item">
                                ...
                                <a href="<?php echo base_url(); ?>Mentor/hapus_filepresensi/<?php echo $tahun_selected.'/'.$semester_selected.'/'.$kelompok_selected.'/'.$f->mingguke ?>" class="badge bg-red">HAPUS</a>
                            </div>
                        <?php endforeach ?>
                    </div>
                    <div class="row clearfix">
                        ...
                        <div class="col-xs-6">
                            <a href="<?php echo base_url(); ?>Mentor/download_filepresensi/<?php echo $kelompok_selected ?>" class="btn btn-primary btn-block waves-effect"><i class="material-icons">file_download</i> UNDUH</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="tambah-file" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form autocomplete="off" role="form" action="<?php echo base_url(); ?>Mentor/tambah_filepresensi/<?php echo $tahun_selected.'/'.$semester_selected.'/'.$kelompok_selected ?>" method="post" enctype="multipart/form-data">
