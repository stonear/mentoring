<div class="row clearfix">
    <div class="col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form autocomplete="off" role="form" action="<?php echo base_url(); ?>Pembina/presensimentor" method="post">
                    <div class="row clearfix">
                        <div class="col-md-4">
...
<?php if(!empty($mentor)): ?>
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="card">
                <div class="body">
                    <form autocomplete="off" role="form" action="<?php echo base_url(); ?>Pembina/update_presensimentor/<?php echo $tahun_selected.'/'.$semester_selected ?>" method="post">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="body">
                    <a href="<?php echo base_url(); ?>Pembina/download_presensimentor/<?php echo $tahun_selected.'/'.$semester_selected ?>" class="btn btn-primary btn-block waves-effect"><i class="material-icons">file_download</i> UNDUH</a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="body">
                    <a href="<?php echo base_url(); ?>Pembina/download_templatepresensimentor/<?php echo $tahun_selected.'/'.$semester_selected ?>" class="btn btn-primary btn-block waves-effect"><i class="material-icons">file_download</i> UNDUH</a>
                </div>
            </div>
        </div>
        <div class="col-md-5">
                    ...
                    <div class="list-group">
                        <?php foreach ($file as $f): ?>
                            ...
                            <div class="list-group-item">
                                ...
                                <a href="<?php echo base_url(); ?>Pembina/hapus_filepresensimentor/<?php echo $tahun_selected.'/'.$semester_selected.'/'.$f->mingguke ?>" class="badge bg-red">HAPUS</a>
                            </div>
                        <?php endforeach ?>
                    </div>
                    <div class="row clearfix">
                        ...
                        <div class="col-xs-6">
                            <a href="<?php echo base_url(); ?>Pembina/download_filepresensimentor/<?php echo $tahun_selected.'/'.$semester_selected ?>" class="btn btn-primary btn-block waves-effect"><i class="material-icons">file_download</i> UNDUH</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="tambah-file" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form autocomplete="off" role="form" action="<?php echo base_url(); ?>Pembina/tambah_filepresensimentor/<?php echo $tahun_selected.'/'.$semester_selected ?>" method="post" enctype="multipart/form-data">
