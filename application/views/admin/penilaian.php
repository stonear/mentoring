                    ...
                    <?php if ($kelas_selected != -1 && $kelompok_selected == -1): ?>
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="body">
                                    <a href="<?php echo base_url(); ?>Admin/download_penilaian_kelas/<?php echo $kelas_selected ?>" class="btn btn-primary btn-block waves-effect"><i class="material-icons">file_download</i> UNDUH</a>
                                </div>
                            </div>
                        </div>
                    <?php endif ?> 
	...
	<div class="row clearfix">
        <div class="col-md-12">
            <div class="card">
                ...
                <?php endif ?>
                <div class="body">
                    <form autocomplete="off" role="form" action="<?php echo base_url(); ?>Admin/update_penilaian/<?php echo $tahun_selected.'/'.$semester_selected.'/'.$kelas_selected.'/'.$kelompok_selected ?>" method="post">
