...
class Admin extends CI_Controller
{
	...
	public function download_penilaian_kelas($kelas)
	{
		$this->load->library('excel');
		$styleArray = array
		(
		...
		$objPHPExcel->getActiveSheet()->setCellValue('A3', 'Dosen Kelas:');
		$objPHPExcel->getActiveSheet()->getStyle('A3')->applyFromArray($bold);

		$dosen = $this->kelas->select_dosen($kelas);
		$objPHPExcel->getActiveSheet()->setCellValue('B3', $dosen[0]->nama);
	...
	public function sync2()
	{
		...
		$listKelas = array('__TPB', '13030', '21030', '21038', '21039', '22030', '22038', '22039', '23030', '23039', '24030', '24031', '31030', '31031', '31032', '31033', '31038', '31039', '61030', '62030', '63030', '64030', '71030', '72030', '73030', '74030', '31040', '31041', '33040', '65040', '71040', '72040', '73040', '74040', '31043', '21041', '23041', '13041', '31042', '21042', '22041', '24041');
	...
	public function tambah_fileverifikasipenilaian($tahun, $semester, $kelas)
	{
		...
		$this->session->set_flashdata('semester', $semester);
		$this->session->set_flashdata('kelas', $kelas);
		redirect('Admin/verifikasipenilaian');
	}
